...
RSpec.describe "ScreenPlayers" do
  ...
  describe "GET /screens/:screen_id/screen_player/new" do
    it "returns a successful response" do
      get new_screen_player_path(screen)
  ...
  describe "POST /screens/:screen_id/screen_player" do
    ...
    it "pairs the player to the screen" do
      post screen_player_path(screen), params: { code: player.pairing_code }
    ...
    it "redirects with alert for unknown code" do
      post screen_player_path(screen), params: { code: "XXXXXX" }
      expect(response).to redirect_to(new_screen_player_path(screen))
  ...
  describe "DELETE /screens/:screen_id/screen_player" do
    it "unpairs the player" do
      ...
      delete screen_player_path(screen)
  ...
  describe "tenant isolation" do
    it "returns 404 for another account's screen" do
      ...
      get new_screen_player_path(other_screen)
