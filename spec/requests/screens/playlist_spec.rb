...
RSpec.describe "Screen Playlist", type: :request do
  ...
  describe "POST /screens/:screen_id/screen_playlist" do
    it "assigns a playlist to the screen" do
      expect {
        post screen_screen_playlist_path(screen), params: { screen_playlist: { playlist_id: playlist.id } }
  ...
  describe "tenant isolation" do
    it "returns 404 for another account's screen" do
      ...
      get new_screen_screen_playlist_path(other_screen)
