...
RSpec.describe "PaperTrail versioning" do
  ...
  describe "metadata" do
    it "stores object_changes as jsonb" do
      ...
      expect(version.object_changes["price"]).to eq([ 500_000, 450_000 ])
    end
  end
end
