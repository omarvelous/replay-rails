...
RSpec.describe InvitePolicy do
  ...
  context "when user is owner" do
    ...
    it "permits creating any role" do
      ...
      p = described_class.new(manager_invite, user: user, account: account, account_user: account_user)
  ...
  context "when user is manager" do
    ...
    it "permits creating agent invites" do
      ...
      p = described_class.new(agent_invite, user: user, account: account, account_user: account_user)
      expect(p).to permit(:create?)
    end
