    ...
    <Popover className="relative isolate z-50 shadow-sm">
      ...
      >
        ...
        <div className="relative bg-white dark:bg-gray-900">
          <div className="mx-auto grid max-w-7xl gap-x-4 px-6 py-10 sm:grid-cols-2 lg:grid-cols-4 lg:px-8 xl:gap-x-8">
            {solutions.map((item) => (
              <div
                key={item.name}
          ...
          <div className="bg-gray-50 dark:bg-gray-800/50">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="grid divide-gray-900/5 border-x border-gray-900/5 sm:grid-cols-3 sm:divide-x dark:divide-white/5 dark:border-white/10">
                {callsToAction.map((item) => (
                  <a
                    key={item.name}
                    href={item.href}
                    className="flex items-center gap-x-2.5 p-3 text-sm/6 font-semibold text-gray-900 hover:bg-gray-100 sm:justify-center dark:text-white dark:hover:bg-gray-800"
                  >
