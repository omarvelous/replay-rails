          ...
          <TabGroup as="div">
            ...
            <TabPanels as="template">
              <TabPanel class="-mb-10">
                ...
                <div v-for="(review, reviewIdx) in reviews.featured" :key="review.id" class="flex space-x-4 text-sm text-gray-500">
                  ...
                  <div :class="[reviewIdx === 0 ? '' : 'border-t border-gray-200', 'flex-1 py-10']">
                    ...
                    <div class="mt-4 text-sm/6 text-gray-500" v-html="review.content"></div>
                  </div>
                </div>
              </TabPanel>
              ...
              <TabPanel class="pt-10">
                ...
                <div class="text-sm text-gray-500 *:first:mt-0 [&_h4]:mt-5 [&_h4]:font-medium [&_h4]:text-gray-900 [&_li]:pl-2 [&_li::marker]:text-gray-300 [&_p]:my-2 [&_p]:text-sm/6 [&_ul]:my-4 [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:pl-5 [&_ul]:text-sm/6" v-html="license.content"></div>
              </TabPanel>
            </TabPanels>
          </TabGroup>
        </div>
