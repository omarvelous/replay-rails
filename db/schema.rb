...
ActiveRecord::Schema[8.1].define(version: 2026_09_19_200000) do
  ...
  create_table "account_users", force: :cascade do |t|
    ...
    t.index ["public_id"], name: "index_account_users_on_public_id", unique: true
  ...
  create_table "ads", force: :cascade do |t|
    ...
    t.index ["public_id"], name: "index_ads_on_public_id", unique: true
  end
  ...
  create_table "agent_ads", force: :cascade do |t|
    ...
    t.index ["public_id"], name: "index_agent_ads_on_public_id", unique: true
  end
  ...
  create_table "brand_ads", force: :cascade do |t|
    ...
    t.uuid "public_id", default: -> { "gen_random_uuid()" }, null: false
    t.datetime "updated_at", null: false
    t.index ["public_id"], name: "index_brand_ads_on_public_id", unique: true
  end
  ...
  create_table "collection_ad_ads", force: :cascade do |t|
    ...
    t.index ["public_id"], name: "index_collection_ad_ads_on_public_id", unique: true
  end
  ...
  create_table "collection_ads", force: :cascade do |t|
    ...
    t.uuid "public_id", default: -> { "gen_random_uuid()" }, null: false
    t.datetime "updated_at", null: false
    t.index ["public_id"], name: "index_collection_ads_on_public_id", unique: true
  end
  ...
  create_table "inquiries", force: :cascade do |t|
    ...
    t.index ["public_id"], name: "index_inquiries_on_public_id", unique: true
  end
  ...
  create_table "lead_agents", force: :cascade do |t|
    ...
    t.index ["public_id"], name: "index_lead_agents_on_public_id", unique: true
  end
  ...
  create_table "listing_ads", force: :cascade do |t|
    ...
    t.index ["public_id"], name: "index_listing_ads_on_public_id", unique: true
  end
  ...
  create_table "listing_agents", force: :cascade do |t|
    ...
    t.index ["public_id"], name: "index_listing_agents_on_public_id", unique: true
  end
  ...
  create_table "listing_experiences", force: :cascade do |t|
    ...
    t.index ["public_id"], name: "index_listing_experiences_on_public_id", unique: true
  end
  ...
  create_table "listings", force: :cascade do |t|
    ...
    t.index ["public_id"], name: "index_listings_on_public_id", unique: true
  end
  ...
  create_table "playlist_ads", force: :cascade do |t|
    ...
    t.index ["public_id"], name: "index_playlist_ads_on_public_id", unique: true
  end
  ...
  create_table "playlists", force: :cascade do |t|
    ...
    t.index ["public_id"], name: "index_playlists_on_public_id", unique: true
  end
  ...
  create_table "screen_contents", force: :cascade do |t|
    ...
    t.index ["public_id"], name: "index_screen_contents_on_public_id", unique: true
  ...
  create_table "screen_players", force: :cascade do |t|
    ...
    t.index ["public_id"], name: "index_screen_players_on_public_id", unique: true
  ...
  create_table "screens", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["public_id"], name: "index_screens_on_public_id", unique: true
